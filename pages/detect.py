...
if(st.session_state['start_session'] == False):
    st.batch_name = detection_widgets.batch_name_input(
        'PWB Condition Classifcation')
    st.product_model = detection_widgets.product_model_input('PWB')
    st.department = detection_widgets.department_input('Electronics')
    ...
    webrtc_ctx = webrtc_streamer(
        ...
        video_processor_factory=ClassificationVideoProcessorMaker(database).make(),
